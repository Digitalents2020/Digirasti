        ...
        <div className="mainPageFrame">
          <div className="innerPageFrame">
            ...
            <div className="pageContentFrame">
              ...
              <p>
                Liiku tekstissä nuolinäppäimillä ja poista tekstistä kaikki
                numerot. Tehtävä on ajastettu.
              </p>
            </div>
          </div>
          <div className="pageContentFrame">
            ...
            <textarea
              className="textWritingArea largeTextarea"
              onChange={textChangeEvent}
              value={taskText}
            ></textarea>
            <button
              className="actionButton"
              onClick={tarkistusFunktio}
        ...
        <div className="mainPageFrame">
          <div className="innerPageFrame">
            ...
            <div className="pageContentFrame">
              ...
              <p>
                Liiku tekstissä nuolinäppäimillä ja poista tekstistä kaikki
                numerot. Tehtävä on ajastettu, klikkaa "Aloita tehtävä"
                painiketta aloittaaksesti tehtävä.
              </p>
            </div>
          </div>
          <div className="pageContentFrame">
